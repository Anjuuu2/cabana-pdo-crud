...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        $stmt->execute();
        // Redirect to success.php after successful address recording
...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background-image: url('https://upload-os-bbs.hoyolab.com/upload/2022/03/30/208559377/b73ecab2d7d6d6fd1da1b35c541d5a1d_7652872992962139676.jpg'); /* Replace 'your_background_image.jpg' with the path to your image */
