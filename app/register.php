...
<head>
    ...
    <style>
      body{ 
            ...
            background-image: url('https://wallpapercave.com/wp/wp7648620.png'); /* Specify the path to your background image */
    ...
    border-radius: 20px;
    box-shadow: 0px 0px 30px rgba(255, 69, 0, 0.7), 0 0 0 0px black; /* Orange shadow and black border */
